...
class _AuthRemoteDataSource implements AuthRemoteDataSource {
  ...
  Future<ProfileApiResponse> updateProfile(UpdateProfileRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ProfileApiResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProfileApiResponse _value;
    try {
  ...
  @override
  Future<ProfileApiResponse> getCurrentUserProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
