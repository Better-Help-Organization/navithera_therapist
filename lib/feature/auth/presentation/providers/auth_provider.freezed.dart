...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message) unverified,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String message)? unverified,
...
class _$UnverifiedImpl implements _Unverified {
  const _$UnverifiedImpl(this.message);
  ...
  @override
  String toString() {
    return 'AuthState.unverified(message: $message)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return unverified?.call(message);
  }
...
abstract class _Unverified implements AuthState {
  const factory _Unverified(final String message) = _$UnverifiedImpl;
...
abstract class _ProfileError implements AuthState {
  const factory _ProfileError(final User user, final String message) =
      _$ProfileErrorImpl;
